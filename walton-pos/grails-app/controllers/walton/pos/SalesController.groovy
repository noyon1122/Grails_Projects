...
class SalesController {
    ...
    def list() {
        ...
        def sales = Sales.createCriteria().list {
            if (params.saleNo) {
    ...
    def add()
    {
        ...
        def uniquecustomerAcount = salesService.generateCustomerAcNo()
        def uniquecustomerId = salesService.generateCustomerId()
        ...
        def sale=new Sales()
        def uniqueSaleNo = salesService.generateSaleNo()
